...
$solicitudes = "";
if ((isset($_POST['id']))) {
    $consulta1 = "SELECT * FROM aspirantesWHERE  where idempleo= '" . $_POST['id'] . "'";
    ...
    while ($fila1 = $result1->fetch_assoc()) {
        ...
        <div class="card-body">
            ...
            <a href="#" id="' . $fila1["idempleo"] . '" class="btn btn-primary" onclick="postularse(this.id)>Postular para el Empleo</a>
        </div>
    </div>';
        }
    }
